...
export type LeadStage = 'new' | 'contacted' | 'qualified' | 'demo' | 'won' | 'lost';
...
export interface Message {
  id: string | number; // String for client temporary UUIDs, number for server IDs
